import { shader, vec4, vec3 } from 'brometal';
import { rotate3, shadowDepth } from 'brometal/shader-functions';
...
export default shader({
  ...
  vertex({ aPosition, iOffset, iScale, iSpin }, { uLightViewProj, uLightPos, uTime, uRange }, v) {
    ...
    // shadowDepth and shadowFactor share this formula, so the map and the
    // comparison against it cannot drift apart.
