...
const GameLit: CompiledShader<{ aPosition: 'vec3'; aNormal: 'vec3' }, Record<string, never>, { uViewProj: 'mat4'; uModel: 'mat4'; uColor: 'vec3'; uLightDir: 'vec3' }> = {
