...
const BallsFloor: CompiledShader<{ aPosition: 'vec3' }, Record<string, never>, { uViewProj: 'mat4'; uBounds: 'vec3'; uViewPos: 'vec3'; uLightPos: 'vec3'; uSkyTint: 'vec3'; uGroundTint: 'vec3'; uLightViewProj: 'mat4'; uShadowMap: 'sampler2D'; uRange: 'float'; uTexel: 'float'; uSoftness: 'float'; uBias: 'float' }> = {
