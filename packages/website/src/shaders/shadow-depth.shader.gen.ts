...
const ShadowDepth: CompiledShader<{ aPosition: 'vec3' }, { iOffset: 'vec3'; iScale: 'vec3'; iSpin: 'float' }, { uLightViewProj: 'mat4'; uLightPos: 'vec3'; uTime: 'float'; uRange: 'float' }> = {
