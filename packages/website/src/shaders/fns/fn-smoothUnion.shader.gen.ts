...
const fnSmoothUnionShader: CompiledShader<{ aPosition: 'vec3'; aUv: 'vec2' }, Record<string, never>, { uTime: 'float'; uAspect: 'float' }> = {
...
void main() {
  ...
  float box = sdBox2(p, vec2(0.18, 0.12));
...
fn fs_main(bm_in : BmVSOut) -> @location(0) vec4f {
  ...
  let box = sdBox2(p, vec2f(0.18, 0.12));
  let d = smoothUnion(circle, box, 0.1);
...
export default fnSmoothUnionShader;
