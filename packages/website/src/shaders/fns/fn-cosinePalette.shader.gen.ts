...
const FnCosinePalette: CompiledShader<{ aPosition: 'vec3'; aUv: 'vec2' }, Record<string, never>, { uTime: 'float'; uAspect: 'float' }> = {
...
fn fs_main(bm_in : BmVSOut) -> @location(0) vec4f {
  let color = cosinePalette(bm_in.vUv.x + bm_u.uTime * 0.1, vec3f(0.5, 0.5, 0.5), vec3f(0.5, 0.5, 0.5), vec3f(1.0, 1.0, 1.0), vec3f(0.0, 0.33, 0.67));
...
export default FnCosinePalette;
