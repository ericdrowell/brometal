...
const fnLambertShader: CompiledShader<{ aPosition: 'vec3'; aUv: 'vec2' }, Record<string, never>, { uTime: 'float'; uAspect: 'float' }> = {
...
void main() {
  ...
  if (r < 1.0) {
    ...
    float v = lambert(normal, lightDir);
    color = vec3(v, v, v);
  }
...
export default fnLambertShader;
