...
const FnHash11: CompiledShader<{ aPosition: 'vec3'; aUv: 'vec2' }, Record<string, never>, { uTime: 'float'; uAspect: 'float' }> = {
...
fn fs_main(bm_in : BmVSOut) -> @location(0) vec4f {
  let n = hash11(floor(bm_in.vUv.x * 24.0) + floor(bm_u.uTime) * 24.0);
