...
const fnSdCircleShader: CompiledShader<{ aPosition: 'vec3'; aUv: 'vec2' }, Record<string, never>, { uTime: 'float'; uAspect: 'float' }> = {
...
void main() {
  ...
  float d = sdCircle(p, 0.22 + 0.06 * cos(uTime));
...
fn fs_main(bm_in : BmVSOut) -> @location(0) vec4f {
  ...
  let d = sdCircle(p, 0.22 + 0.06 * cos(bm_u.uTime));
...
export default fnSdCircleShader;
