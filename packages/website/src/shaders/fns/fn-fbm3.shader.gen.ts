...
const fnFbm3Shader: CompiledShader<{ aPosition: 'vec3'; aUv: 'vec2' }, Record<string, never>, { uTime: 'float'; uAspect: 'float' }> = {
...
void main() {
  ...
  float n = fbm3(vec3(p.x, p.y, uTime * 0.35), 5.0);
...
fn fs_main(bm_in : BmVSOut) -> @location(0) vec4f {
  ...
  let n = fbm3(vec3f(p.x, p.y, bm_u.uTime * 0.35), 5.0);
