...
const fnVoronoi2Shader: CompiledShader<{ aPosition: 'vec3'; aUv: 'vec2' }, Record<string, never>, { uTime: 'float'; uAspect: 'float' }> = {
...
fn fs_main(bm_in : BmVSOut) -> @location(0) vec4f {
  let p = vec2f(bm_in.vUv.x * bm_u.uAspect, bm_in.vUv.y) * 5.0 + vec2f(bm_u.uTime * 0.3, bm_u.uTime * 0.12);
  let n = voronoi2(p);
...
export default fnVoronoi2Shader;
