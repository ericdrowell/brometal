...
const BallsShadow: CompiledShader<{ aPosition: 'vec3' }, { iIndex: 'float' }, { uLightViewProj: 'mat4'; uState: 'sampler2D'; uCount: 'float'; uRadius: 'float'; uLightPos: 'vec3'; uRange: 'float' }> = {
